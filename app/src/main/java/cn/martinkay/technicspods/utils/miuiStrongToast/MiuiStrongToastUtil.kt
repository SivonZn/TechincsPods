package cn.martinkay.technicspods.utils.miuiStrongToast
...
import cn.martinkay.technicspods.utils.SystemApisUtils.isHyperOS
import cn.martinkay.technicspods.utils.miuiStrongToast.data.BatteryParams
import cn.martinkay.technicspods.utils.miuiStrongToast.data.IconParams
import cn.martinkay.technicspods.utils.miuiStrongToast.data.Left
...
import cn.martinkay.technicspods.utils.miuiStrongToast.data.Right
import cn.martinkay.technicspods.utils.miuiStrongToast.data.StringToastBean
import cn.martinkay.technicspods.utils.miuiStrongToast.data.TextParams
...
object MiuiStrongToastUtil {
    ...
    fun showStringToast(context: Context, text: String?, colorType: Int) {
        ...
        try {
            ...
            Log.e("TechnicsPods", "Failed to show HyperOS String Toast")
        }
    }
    ...
    fun showPodsBatteryToast(
        ...
        try {
            ...
            Log.e("TechnicsPods", "Failed to show Pods Battery Toast")
        }
    }
    ...
    fun showPodsBatteryToastByMiuiBt(
        ...
        val intent = Intent("chen.action.technicspods.sendstrongtoast")
    ...
    fun showPodsNotificationByMiuiBt(
        ...
        val intent = Intent("chen.action.technicspods.updatepodsnotification")
        intent.putExtra("batteryParams", batteryParams)
        intent.putExtra("device", device)
        notificationSettings.putExtras(intent)
        intent.putExtra(TechnicsPodsAction.EXTRA_RFCOMM_CONNECTED, rfcommConnected)
        intent.`package` = "com.xiaomi.bluetooth"
        context.sendBroadcast(intent)
    }
    ...
    fun cancelPodsNotificationByMiuiBt(
        ...
        val intent = Intent("chen.action.technicspods.cancelpodsnotification")
        intent.putExtra("device", device)
        intent.`package` = "com.xiaomi.bluetooth"
        context.sendBroadcast(intent)
    }
