...
object FocusIslandUtil {
    private const val TAG = "TechnicsPods-FocusIsland"
    private const val CHANNEL_ID = "technicspods_focus_island"
    private const val CHANNEL_NAME = "TechnicsPods Battery"
    private const val NOTIFICATION_ID = 10086
    private const val MODULE_PACKAGE = "cn.martinkay.technicspods"
    ...
    fun showBatteryIsland(context: Context, batteryParams: BatteryParams): Boolean {
        try {
            ...
            val notification = Notification.Builder(context, CHANNEL_ID)
                ...
                .setContentTitle("TechnicsPods")
                .setContentText(contentText)
                .setTicker("TechnicsPods")
                .addExtras(extras)
                .build()
