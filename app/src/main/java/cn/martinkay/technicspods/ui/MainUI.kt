...
import cn.martinkay.technicspods.MainActivity
import cn.martinkay.technicspods.R
import cn.martinkay.technicspods.pods.AppRfcommController
...
fun MainUI(
    ...
    DisposableEffect(Unit) {
        ...
        context.sendBroadcast(Intent(TechnicsPodsAction.ACTION_REFRESH_STATUS).apply {
            setPackage("com.android.bluetooth")
            putExtra(TechnicsPodsAction.EXTRA_ALLOW_RFCOMM_RECONNECT, true)
        })
    ...
    fun setGameMode(enabled: Boolean) {
        ...
        Intent(TechnicsPodsAction.ACTION_GAME_MODE_SET).apply {
    ...
    fun broadcastNotificationSettings(
        ...
        listOf("com.android.bluetooth", "com.xiaomi.bluetooth").forEach { targetPackage ->
            Intent(TechnicsPodsAction.ACTION_NOTIFICATION_SETTINGS_CHANGED).apply {
            ...
            Scaffold(
                ...
                SettingsPage(
                    ...
                    onAdaptiveModeChange = {
                        ...
                        listOf("com.android.bluetooth", "com.xiaomi.bluetooth").forEach { targetPackage ->
                            Intent(TechnicsPodsAction.ACTION_ADAPTIVE_MODE_CHANGED).apply {
                                setPackage(targetPackage)
                                putExtra("enabled", it)
                                addFlags(Intent.FLAG_RECEIVER_FOREGROUND)
                                context.sendBroadcast(this)
                    ...
                    onShowConnectionBatteryIslandChange = {
                        ...
                        prefs.edit()
                            .putBoolean(TechnicsPodsPrefsKey.SHOW_CONNECTION_BATTERY_ISLAND, it)
                            .commit()
                    ...
                    onShowConnectionNotificationChange = {
                        ...
                        prefs.edit()
                            .putBoolean(TechnicsPodsPrefsKey.SHOW_CONNECTION_NOTIFICATION, it)
                            .commit()
                        broadcastNotificationSettings(
                    ...
                    onNotificationIslandStyleChange = {
                        ...
                        prefs.edit()
                            .putBoolean(TechnicsPodsPrefsKey.NOTIFICATION_ISLAND_STYLE, it)
                            .commit()
                        broadcastNotificationSettings(
                            showConnectionBatteryIsland.value,
                            showConnectionPopup.value,
        ...
        entry<Screen.AdvancedSettings> {
            ...
            Scaffold(
                ...
                AdvancedSettingsPage(
                    ...
                    contentPadding = padding,
                    openTechnics = openTechnics,
                    onOpenTechnicsChange = {
                        openTechnics.value = it
                    ...
                    onGameModeImplementationChange = {
                        ...
                        prefs.edit()
                            ...
                            .apply()
                        Intent(TechnicsPodsAction.ACTION_GAME_MODE_IMPLEMENTATION_CHANGED).apply {
                            setPackage("com.android.bluetooth")
                    ...
                    onShowConnectionPopupChange = {
                        ...
                        prefs.edit()
                            .putBoolean(TechnicsPodsPrefsKey.SHOW_CONNECTION_POPUP, it)
                            .commit()
                        broadcastNotificationSettings(
                            showConnectionBatteryIsland.value,
                            it,
                    ...
                    onConnectionPopupDismissSecondsChange = {
                        ...
                        prefs.edit()
                            .putInt(TechnicsPodsPrefsKey.CONNECTION_POPUP_DISMISS_SECONDS, it)
                            .commit()
                        broadcastNotificationSettings(
                            showConnectionBatteryIsland.value,
                            showConnectionPopup.value,
