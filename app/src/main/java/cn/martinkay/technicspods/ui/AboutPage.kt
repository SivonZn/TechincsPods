...
import cn.martinkay.technicspods.ui.effect.BgEffectBackground
import cn.martinkay.technicspods.ui.effect.ColorBlendToken
...
fun SettingsPage(
    ...
    showConnectionBatteryIsland: MutableState<Boolean> =
        mutableStateOf(TechnicsPodsPrefsKey.DEFAULT_SHOW_CONNECTION_BATTERY_ISLAND),
    onShowConnectionBatteryIslandChange: (Boolean) -> Unit = {},
    showConnectionNotification: MutableState<Boolean> =
        mutableStateOf(TechnicsPodsPrefsKey.DEFAULT_SHOW_CONNECTION_NOTIFICATION),
    onShowConnectionNotificationChange: (Boolean) -> Unit = {},
    notificationIslandStyle: MutableState<Boolean> =
        mutableStateOf(TechnicsPodsPrefsKey.DEFAULT_NOTIFICATION_ISLAND_STYLE),
...
fun AdvancedSettingsPage(
    modifier: Modifier = Modifier,
    contentPadding: PaddingValues = PaddingValues(0.dp),
    openTechnics: MutableState<Boolean> = mutableStateOf(false),
    onOpenTechnicsChange: (Boolean) -> Unit = {},
    ...
    showConnectionPopup: MutableState<Boolean> =
        mutableStateOf(TechnicsPodsPrefsKey.DEFAULT_SHOW_CONNECTION_POPUP),
    onShowConnectionPopupChange: (Boolean) -> Unit = {},
    connectionPopupDismissSeconds: MutableState<Int> =
        mutableStateOf(TechnicsPodsPrefsKey.DEFAULT_CONNECTION_POPUP_DISMISS_SECONDS),
    ...
    val popupDismissSecondOptions = TechnicsPodsPrefsKey.CONNECTION_POPUP_DISMISS_SECOND_OPTIONS
    ...
    val popupDismissSecondSelectedIndex = popupDismissSecondOptions
        ...
        .takeIf { it >= 0 }
        ?: popupDismissSecondOptions.indexOf(TechnicsPodsPrefsKey.DEFAULT_CONNECTION_POPUP_DISMISS_SECONDS)
        ...
        item {
            Card {
                ...
                SwitchPreference(
                    ...
                    checked = openTechnics.value,
                    onCheckedChange = { onOpenTechnicsChange(it) }
                )
            }
        }
    }
                ...
                Column(
                    ...
                    Card(
                        ...
                        ArrowPreference(
                            ...
                            onClick = { uriHandler.openUri("https://github.com/Leaf-lsgtky/TechnicsPods") }
                        )
                    }
